/**
 * PM2 Configuration — Production Environment
 * Usage: pm2 start ecosystem.prod.config.js
 *
 * Production NEVER wipes the database.
 * The deploy script (run-prod-server.sh) only runs migrations — no seed, no delete.
 *
  ...
  apps: [
    {
      ...
      env: {
        ...
        NEXT_PUBLIC_SITE_URL_PROD: 'https://atech.software',
        PAYLOAD_PUBLIC_SERVER_URL_PROD: 'https://atech.software',
        NEXT_PUBLIC_DOMAIN_PROD: 'https://atech.software',
