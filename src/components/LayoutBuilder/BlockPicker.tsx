...
const BLOCK_ICONS: Record<string, string> = {
  ...
  'services': '⚙', 'services-mascot': '🐱', 'testimonials': '❝', 'contact': '✉', 'card-grid': '🃏',
...
const BLOCK_LABELS: Record<string, string> = {
  ...
  'features': 'Features', 'services': 'Services', 'services-mascot': 'Services — Mascot', 'testimonials': 'Testimonials',
  ...
  'culture-values': 'Culture Values', 'community-hero': 'Community Hero',
  ...
  'insights-advantages': 'Insights Advantages',
  'insights-tech-guide': 'Insights Tech Guide',
