// Web Dev Service Hero — Figma node 1:27907
// White background, breadcrumb nav, 2-col: badge+heading+body+CTAs | bordered image

import Link from 'next/link'

// ─── Figma asset URLs ─────────────────────────────────────────────────────────
const BREADCRUMB_CHEVRON = 'https://www.figma.com/api/mcp/asset/5e62efcb-3f15-4ee0-9348-e3bf013bb0c0'
const CTA_ARROW          = 'https://www.figma.com/api/mcp/asset/3fb05dfd-653c-4fc6-b9f8-8bb75b1e65ed'
...
// ─── WebDevHeroBlock ──────────────────────────────────────────────────────────
export default function WebDevHeroBlock({ data }: { data: WebDevHeroData }) {
      ...
      <section className="px-6 md:px-10 pb-24 pt-10" style={{ background: '#ffffff' }}>
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={badgeIconSrc} alt="" className="w-3 h-3 object-contain flex-shrink-0" />
              <span
