  ...
  // ── Hero ────────────────────────────────────────────────────────────────────
  {
    ...
    overrides: {
      content: {
        ...
        buttonUrl: '/services',
        items: [
          { label: 'Get in Touch', url: '/static/contact' },           // secondary CTA (no value = not a stat)
    ...
    overrides: {
      content: {
        ...
        items: [
          ...
          { icon: '</>',  label: 'Product Development',  content: 'Design and develop scalable digital products.',        url: '/static/contact'                  },
        ],
      },
    },
  },
    ...
    overrides: {
      content: {
        ...
        items: [
          ...
          { icon: '</>',  label: 'Product Development',  content: 'End-to-end product design and engineering — from MVP through scale — with your vision at the centre.',       url: '/static/contact'                  },
        ],
      },
    },
  },
