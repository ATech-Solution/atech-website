  ...
  apps: [
    {
      ...
      env: {
        ...
        NEXT_PUBLIC_SITE_URL_PROD: 'https://dev.atech.software',
        PAYLOAD_PUBLIC_SERVER_URL_PROD: 'https:/dev.atech.software',
        NEXT_PUBLIC_DOMAIN_PROD: 'https://dev.atech.software',
